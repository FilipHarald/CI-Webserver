...
var vector = (
	function () {
	    ...
	    vector.prototype.split = function(){
	    	return new vector(this.getX()/2, this.getY()/2);
	    }
	    ...
	    vector.prototype.normalise = function () {
	        ...
	        // console.log("Distance of normalisation" + distance);
	    ...
	    vector.prototype.normalVector = function(otherVector){
	    	var xDistance =  otherVector.getX()-this.getX();
    		var yDistance =  otherVector.getY()-this.getY();
    		// console.log(xDistance);
    	
    		var v = new vector(xDistance, yDistance);
