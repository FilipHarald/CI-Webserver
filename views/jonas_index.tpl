    ...
    <head>
        ...
        <body onload="init();">
            <section class="page-header">
                <h1 class="project-name">Jonas Hardkode</h1>
                <h2 class="project-tagline"></h2>
                <a href="box" class="btn">Magic Box</a>
                <a href="facebookComment" class="btn">Commenting</a>
                <a href="spotifySearch" class="btn">Spotify Search</a>
                <a href="game" class="btn">Game of Doom</a>
            </section>
            <section class="main-content">
                <h3> Use the buttons to navitgate. This site is currently under contstruction and is mainly used for learning and test purposes.
